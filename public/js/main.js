...
var $author$project$Messages$GeneratedId = function (a) {
	return {$: 'GeneratedId', a: a};
};
var $author$project$Model$Model$Guest = F2(
	function (a, b) {
...
var $author$project$Model$Error$Add = function (a) {
	return {$: 'Add', a: a};
};
...
var $author$project$Messages$VoteAccepted = function (a) {
	return {$: 'VoteAccepted', a: a};
};
var $author$project$Messages$VoteCancelled = function (a) {
	return {$: 'VoteCancelled', a: a};
};
var $author$project$Model$Ballots$Ballot = F2(
...
var $author$project$Model$Nation$citizenDecoder = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Model$Nation$Citizen,
...
var $author$project$Sse$decodeData = F2(
	function (decoder, event) {
		return A2(
			$elm$core$Result$mapError,
			$elm$json$Json$Decode$errorToString,
			A2($elm$json$Json$Decode$decodeValue, decoder, event.data));
	});
...
var $author$project$Main$dispatch = function (event) {
	...
	switch (_v0) {
		case 'enlisted':
			return A2(
				$elm$core$Result$map,
				$author$project$Messages$NewCitizen,
				A2($author$project$Sse$decodeData, $author$project$Model$Nation$citizenDecoder, event));
		case 'voteAccepted':
			return A2(
				$elm$core$Result$map,
				$author$project$Messages$VoteAccepted,
				A2($author$project$Sse$decodeData, $author$project$Model$Ballots$ballotDecoder, event));
		case 'voteCancelled':
			return A2(
				$elm$core$Result$map,
		...
		case 'citizenLeft':
			return A2(
				$elm$core$Result$map,
				$author$project$Messages$CitizenLeft,
				A2($author$project$Sse$decodeData, $author$project$Model$Nation$citizenDecoder, event));
		case 'sync':
			return A2(
				$elm$core$Result$map,
...
var $author$project$Tools$fold = F3(
	function (errorF, successF, result) {
		if (result.$ === 'Err') {
			var error = result.a;
			return errorF(error);
		} else {
			var success = result.a;
			return successF(success);
		}
	});
var $author$project$Sse$Event = F2(
	function (kind, data) {
		return {data: data, kind: kind};
	});
var $author$project$Sse$through = F2(
	function (dispatchF, _v0) {
		var kind = _v0.a;
		var data = _v0.b;
		return dispatchF(
			A2($author$project$Sse$Event, kind, data));
	});
var $author$project$Main$handleEvent = function (event) {
	return A3(
		$author$project$Tools$fold,
		function (error) {
			return $author$project$Messages$ErrorMsg(
				$author$project$Model$Error$Add(error));
		},
...
var $author$project$Main$subscriptions = function (_v0) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$author$project$Main$messageReceiver($author$project$Main$handleEvent),
...
var $author$project$Model$Error$Timed = function (a) {
	return {$: 'Timed', a: a};
};
var $author$project$Model$Error$addError = function (error) {
	return A2(
		$elm$core$Task$perform,
		$author$project$Model$Error$Timed,
		A2(
			$elm$core$Task$map,
...
var $author$project$Model$Error$update = F2(
	function (msg, errors) {
		switch (msg.$) {
			case 'Add':
				var content = msg.a;
				return _Utils_Tuple2(
					errors,
					$author$project$Model$Error$addError(content));
			case 'Timed':
				var error = msg.a;
				return _Utils_Tuple2(
					_Utils_ap(
...
var $author$project$Model$Model$Open = function (a) {
	return {$: 'Open', a: a};
};
var $author$project$Model$Model$OpenModel = F2(
	function (context, ballot) {
		return {ballot: ballot, context: context};
	});
var $author$project$Tools$httpErrorToString = function (error) {
	switch (error.$) {
		case 'BadUrl':
			var msg = error.a;
			return msg;
...
var $author$project$Model$Nation$remove = F2(
	function (citizen, nation) {
		return A2($elm$core$Dict$remove, citizen.id, nation);
	});
var $author$project$Model$Model$removeCitizen = F2(
	function (context, citizen) {
		return _Utils_update(
			context,
			{
				nation: A2($author$project$Model$Nation$remove, citizen, context.nation)
			});
	});
var $author$project$Model$Ballots$empty = $elm$core$Dict$fromList(_List_Nil);
var $author$project$Model$Model$reset = function (context) {
	return _Utils_update(
		context,
		{ballots: $author$project$Model$Ballots$empty});
};
var $author$project$Messages$HeartbeatResp = function (a) {
	return {$: 'HeartbeatResp', a: a};
};
...
var $author$project$Model$Nation$encodeCitizen = function (citizen) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'id',
				$elm$json$Json$Encode$string(citizen.id)),
				_Utils_Tuple2(
				'name',
				$elm$json$Json$Encode$string(citizen.name))
			]));
};
...
var $author$project$Model$Ballots$footprint = function (ballots) {
	return $TSFoster$elm_sha1$SHA1$fromString(
		A3(
			$elm$core$List$foldl,
			...
			A2(
				$elm$core$List$map,
				function (ballot) {
					return _Utils_ap(ballot.a, ballot.b);
				},
				$elm$core$Dict$toList(ballots))));
};
var $author$project$Model$Nation$footprint = function (nation) {
	return $TSFoster$elm_sha1$SHA1$fromString(
		A3(
			$elm$core$List$foldl,
			$elm$core$Basics$append,
			...
			A2(
				$elm$core$List$map,
				function (citizen) {
					return _Utils_ap(citizen.id, citizen.name);
				},
				$elm$core$Dict$values(nation))));
};
...
var $author$project$Model$Model$footprint = function (context) {
	return $TSFoster$elm_sha1$SHA1$fromString(
		function (t) {
			return _Utils_ap(t.a, t.b);
		}(
			A3(
				...
				$TSFoster$elm_sha1$SHA1$toHex,
				_Utils_Tuple2(
					$author$project$Model$Nation$footprint(context.nation),
					$author$project$Model$Ballots$footprint(context.ballots)))));
};
var $author$project$Common$heartbeat = function (context) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'citizen',
				$author$project$Model$Nation$encodeCitizen(context.me)),
				_Utils_Tuple2(
				'footprint',
				$elm$json$Json$Encode$string(
					$TSFoster$elm_sha1$SHA1$toHex(
						$author$project$Model$Model$footprint(context))))
			]));
};
...
var $author$project$Common$sendHeartbeat = function (context) {
	return $elm$http$Http$post(
		{
			body: $elm$http$Http$jsonBody(
				$author$project$Common$heartbeat(context)),
			expect: $elm$http$Http$expectWhatever($author$project$Messages$HeartbeatResp),
			url: '/nation/alive'
		});
};
var $author$project$Messages$CmdResp = function (a) {
	return {$: 'CmdResp', a: a};
};
var $elm$http$Http$emptyBody = _Http_emptyBody;
var $author$project$Workflow$Closed$start = $elm$http$Http$post(
	{
			...
			while (true) {
				switch (msg.$) {
					case 'Tick':
						return _Utils_Tuple2(
							model,
							$author$project$Common$sendHeartbeat(context));
					case 'HeartbeatResp':
						if (msg.a.$ === 'Err') {
							var e = msg.a.a;
							if (e.$ === 'BadStatus') {
								return _Utils_Tuple2(
									A2(
										...
										model.errors,
										function (citizen) {
											return A2($author$project$Model$Model$Guest, citizen.id, citizen.name);
										}(context.me)),
									A2(
										$elm$core$Platform$Cmd$map,
										$author$project$Messages$ErrorMsg,
										$author$project$Model$Error$addError('You were kicked out by the server (probably a restart)')));
							} else {
								return _Utils_Tuple2(
									model,
									A2(
										$elm$core$Platform$Cmd$map,
										$author$project$Messages$ErrorMsg,
										$author$project$Model$Error$addError(
...
var $author$project$Model$Deck$Card = F3(
	function (value, iconClass, code) {
		return {code: code, iconClass: iconClass, value: value};
	});
var $author$project$Model$Decks$fwg = _List_fromArray(
	[
		A3($author$project$Model$Deck$Card, '0', 'fas fa-ghost', '0'),
		A3($author$project$Model$Deck$Card, '1', 'fas fa-cat', '1'),
		A3($author$project$Model$Deck$Card, '2', 'fas fa-horse', '2'),
		A3($author$project$Model$Deck$Card, '3', 'fas fa-hippo', '3'),
		A3($author$project$Model$Deck$Card, '2 Big', 'fas fa-dragon', 'too-big'),
		A3($author$project$Model$Deck$Card, '?', 'fas fa-question', 'no-idea')
	]);
var $author$project$Model$Model$contextFrom = F2(
	function (citizen, state) {
		return {ballots: state.ballots, deck: $author$project$Model$Decks$fwg, me: citizen, nation: state.nation, updatedName: citizen.name};
	});
	...
	return $elm$http$Http$post(
		{
			...
			expect: A2($elm$http$Http$expectJson, $author$project$Messages$Enlisted, $author$project$Common$stateDecoder),
			url: '/nation/enlist'
		});
};
		...
		if (_v0.$ === 'Guest') {
			...
			switch (msg.$) {
				case 'Enlist':
					return _Utils_Tuple2(
						model,
						$author$project$Workflow$Guest$serverEnlist(
							A2($author$project$Model$Nation$Citizen, id, guest)));
				case 'GeneratedId':
					var generated = msg.a;
					return _Utils_Tuple2(
						A2(
				...
				case 'Enlisted':
					...
					if (response.$ === 'Err') {
						if (response.a.$ === 'BadStatus') {
							return _Utils_Tuple2(
								...
								A2(
									$elm$core$Platform$Cmd$map,
									$author$project$Messages$ErrorMsg,
									$author$project$Model$Error$addError('This name is taken, please try another')));
						} else {
						...
						return _Utils_Tuple2(
							A2(
								$author$project$Model$Model$openFrom,
								A2($author$project$Model$Nation$Citizen, id, guest),
								state),
							$elm$core$Platform$Cmd$none);
					}
...
var $author$project$Model$Ballots$remove = F2(
	function (citizen, ballots) {
		return A2($elm$core$Dict$remove, citizen, ballots);
	});
var $author$project$Model$Model$cancelVote = F2(
	function (context, citizen) {
		return _Utils_update(
			context,
			{
				ballots: A2($author$project$Model$Ballots$remove, citizen.id, context.ballots)
			});
	});
var $author$project$Workflow$Open$cancelVote = function (citizen) {
	return $elm$http$Http$post(
		{
			body: $elm$http$Http$jsonBody(
				$author$project$Model$Nation$encodeCitizen(citizen)),
...
var $author$project$Workflow$Open$close = $elm$http$Http$post(
	{
		body: $elm$http$Http$emptyBody,
		expect: $elm$http$Http$expectWhatever($author$project$Messages$CmdResp),
		url: '/poll/close'
	});
var $author$project$Model$Nation$enlist = F2(
	function (citizen, nation) {
		return A3($elm$core$Dict$insert, citizen.id, citizen, nation);
	});
var $author$project$Model$Model$enlist = F2(
	function (context, citizen) {
		return _Utils_update(
			context,
			{
...
var $author$project$Model$Model$vote = F2(
	function (context, newBallot) {
		return _Utils_update(
			context,
			{
				ballots: A2($author$project$Model$Ballots$add, newBallot, context.ballots)
			});
	});
var $author$project$Model$Ballots$encode = function (ballot) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'citizen',
				$elm$json$Json$Encode$string(ballot.citizen)),
				_Utils_Tuple2(
				'cardCode',
				$elm$json$Json$Encode$string(ballot.cardCode))
			]));
};
var $author$project$Workflow$Open$vote = function (ballot) {
	return $elm$http$Http$post(
		{
			body: $elm$http$Http$jsonBody(
				$author$project$Model$Ballots$encode(ballot)),
			expect: $elm$http$Http$expectWhatever($author$project$Messages$CmdResp),
			url: '/vote'
		});
};
	...
	function (msg, model) {
		if (msg.$ === 'ErrorMsg') {
			...
			return A3(
				...
				$elm$core$Platform$Cmd$map($author$project$Messages$ErrorMsg),
				A2($author$project$Model$Error$update, errorMsg, model.errors));
		} else {
...
var $author$project$Messages$UpdateName = function (a) {
...
var $author$project$OtherHtml$enlistForm = function (citizen) {
	return A2(
		$elm$html$Html$form,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$placeholder('Who dat ?'),
						$elm$html$Html$Events$onInput($author$project$Messages$UpdateName),
						$elm$html$Html$Attributes$value(citizen)
					]),
				_List_Nil),
				A2(
				$elm$html$Html$button,
...
var $author$project$Model$Error$Delete = function (a) {
	return {$: 'Delete', a: a};
};
var $elm$html$Html$i = _VirtualDom_node('i');
var $author$project$Model$Error$html = function (error) {
	return A2(
		$elm$html$Html$li,
		_List_fromArray(
			[
				$elm$html$Html$Events$onClick(
				$author$project$Model$Error$Delete(error))
			]),
		_List_fromArray(
			[
				A2(
...
var $author$project$Model$Error$view = function (errors) {
	return A2(
		$elm$html$Html$ul,
		_List_fromArray(
			[
		...
		A2($elm$core$List$map, $author$project$Model$Error$html, errors));
};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class(card.iconClass)
						]),
					_List_Nil),
					A2(
					$elm$html$Html$p,
					...
					_List_fromArray(
						[
							$elm$html$Html$text(card.value)
						]))
				]));
	});
var $author$project$Model$Deck$cardHtml = function (card) {
	return A2($author$project$Model$Deck$cardHtml2, card, _List_Nil);
};
var $author$project$Model$Ballots$ballotHtml = function (maybe) {
	if (maybe.$ === 'Nothing') {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
		...
		var card = maybe.a;
		return $author$project$Model$Deck$cardHtml(card);
	}
};
...
var $author$project$Model$Deck$findBy = F2(
	function (code, deck) {
		return $elm$core$List$head(
			A2(
				$elm$core$List$filter,
				function (card) {
					return _Utils_eq(card.code, code);
				},
				deck));
	});
var $author$project$Workflow$Closed$getCard = F3(
	function (citizen, ballots, deck) {
		var _v0 = A2($author$project$Model$Ballots$cardCodeOf, citizen, ballots);
		if (_v0.$ === 'Just') {
			var cardCode = _v0.a;
			return A2($author$project$Model$Deck$findBy, cardCode, deck);
		} else {
			return $elm$core$Maybe$Nothing;
		}
	});
var $author$project$Workflow$Closed$ballotHtml = F3(
	function (citizen, ballots, deck) {
		return $author$project$Model$Ballots$ballotHtml(
			A3($author$project$Workflow$Closed$getCard, citizen, ballots, deck));
	});
var $author$project$Model$Nation$citizenHtml = F2(
	function (citizen, children) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('citizen')
				]),
			_Utils_ap(
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(citizen.name)
							]))
					]),
				children));
	});
var $author$project$Model$Nation$citizens = function (nation) {
	return $elm$core$Dict$values(nation);
};
var $author$project$Workflow$Closed$ballotsHtml = F3(
	function (nation, ballots, deck) {
		return A2(
			$elm$core$List$map,
			function (citizen) {
				return A2(
					$author$project$Model$Nation$citizenHtml,
					citizen,
					_List_fromArray(
						[
							A3($author$project$Workflow$Closed$ballotHtml, citizen, ballots, deck)
						]));
			},
			$author$project$Model$Nation$citizens(nation));
	});
var $author$project$Messages$Start = {$: 'Start'};
var $author$project$OtherHtml$startButton = A2(
	$elm$html$Html$button,
	_List_fromArray(
		[
			$elm$html$Html$Events$onClick($author$project$Messages$Start)
		]),
	_List_fromArray(
		[
			A2(
	...
	if (_v0.$ === 'Closed') {
		...
		return _List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('nation')
					]),
				_Utils_ap(
					A3($author$project$Workflow$Closed$ballotsHtml, context.nation, context.ballots, context.deck),
					_List_fromArray(
						[$author$project$OtherHtml$startButton])))
			]);
	} else {
		return _List_Nil;
	}
};
var $author$project$Messages$Close = {$: 'Close'};
var $author$project$OtherHtml$closeButton = A2(
	$elm$html$Html$button,
	_List_fromArray(
		[
			$elm$html$Html$Events$onClick($author$project$Messages$Close)
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('fas fa-unlock-alt')
				]),
			_List_Nil),
			$elm$html$Html$text(' Close')
		]));
var $author$project$Messages$Cancel = function (a) {
	return {$: 'Cancel', a: a};
};
var $author$project$Messages$Vote = function (a) {
	return {$: 'Vote', a: a};
};
var $author$project$Workflow$Open$notSelectedCardAttributes = F2(
	function (citizen, card) {
		return _List_fromArray(
			[
				$elm$html$Html$Attributes$class('card'),
				$elm$html$Html$Events$onClick(
				$author$project$Messages$Vote(
					A2($author$project$Model$Ballots$Ballot, citizen.id, card.code)))
			]);
	});
var $author$project$Workflow$Open$cardAttributes = F3(
	function (card, citizen, maybeBallot) {
		if (maybeBallot.$ === 'Just') {
			var ballot = maybeBallot.a;
			return _Utils_eq(ballot.cardCode, card.code) ? _List_fromArray(
				[
					$elm$html$Html$Attributes$class('card selected'),
					$elm$html$Html$Events$onClick(
					$author$project$Messages$Cancel(citizen))
				]) : A2($author$project$Workflow$Open$notSelectedCardAttributes, citizen, card);
		} else {
			return A2($author$project$Workflow$Open$notSelectedCardAttributes, citizen, card);
		}
	});
var $author$project$Workflow$Open$deckHtml = F3(
	function (deck, citizen, ballot) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$id('deck')
				]),
			A2(
				$elm$core$List$map,
				function (card) {
					return A2(
						$author$project$Model$Deck$cardHtml2,
						card,
						A3($author$project$Workflow$Open$cardAttributes, card, citizen, ballot));
				},
				deck));
	});
...
var $author$project$Model$Ballots$hasVoted = F2(
	function (citizen, ballots) {
		return A2($elm$core$Dict$member, citizen.id, ballots);
	});
var $author$project$Workflow$Open$voterHtml = F2(
	function (ballots, citizen) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
						...
						[
							...
							_List_fromArray(
								[
									...
									_Utils_Tuple2(
									'full',
									A2($author$project$Model$Ballots$hasVoted, citizen, ballots))
								]))
						]),
					_List_Nil)
				]));
	});
var $author$project$Workflow$Open$votersHtml = F2(
	function (nation, ballots) {
		return A2(
			$elm$core$List$map,
			$author$project$Workflow$Open$voterHtml(ballots),
			$author$project$Model$Nation$citizens(nation));
	});
	...
	if (_v0.$ === 'Open') {
		...
		return _List_fromArray(
			[
				...
				_Utils_ap(
					A2($author$project$Workflow$Open$votersHtml, open.context.nation, open.context.ballots),
					_List_fromArray(
						[$author$project$OtherHtml$closeButton]))),
				A3($author$project$Workflow$Open$deckHtml, open.context.deck, open.context.me, open.ballot)
			]);
	} else {
		return _List_Nil;
	}
		...
		_Utils_ap(
			_List_fromArray(
				[
					...
					$elm$html$Html$map,
					$author$project$Messages$ErrorMsg,
					$author$project$Model$Error$view(model.errors))
				]),
			function () {
				var _v0 = model.workflow;
				switch (_v0.$) {
					...
					case 'Open':
						return $author$project$Workflow$Open$view(model);
					default:
						return $author$project$Workflow$Closed$view(model);
				}
			}()));
};
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Messages.Msg","aliases":{"Model.Ballots.Ballot":{"args":[],"type":"{ citizen : Model.Nation.CitizenId, cardCode : Model.Deck.CardCode }"},"Model.Ballots.Ballots":{"args":[],"type":"Dict.Dict Model.Nation.CitizenId Model.Deck.CardCode"},"Model.Deck.CardCode":{"args":[],"type":"String.String"},"Model.Nation.Citizen":{"args":[],"type":"{ id : Model.Nation.CitizenId, name : String.String }"},"Model.Nation.CitizenId":{"args":[],"type":"String.String"},"Model.Nation.Nation":{"args":[],"type":"Dict.Dict Model.Nation.CitizenId Model.Nation.Citizen"},"Messages.State":{"args":[],"type":"{ nation : Model.Nation.Nation, ballots : Model.Ballots.Ballots }"},"Model.Error.Error":{"args":[],"type":"{ content : String.String, time : Time.Posix }"}},"unions":{"Messages.Msg":{"args":[],"tags":{"CmdResp":["Result.Result Http.Error ()"],"Tick":["Time.Posix"],"Sync":["Messages.State"],"HeartbeatResp":["Result.Result Http.Error ()"],"ErrorMsg":["Model.Error.Msg"],"UpdateName":["String.String"],"GeneratedId":["String.String"],"Enlist":[],"Enlisted":["Result.Result Http.Error Messages.State"],"NewCitizen":["Model.Nation.Citizen"],"Vote":["Model.Ballots.Ballot"],"VoteAccepted":["Model.Ballots.Ballot"],"Cancel":["Model.Nation.Citizen"],"VoteCancelled":["Model.Nation.Citizen"],"Close":[],"PollCLosed":[],"Start":[],"PollStarted":[],"CitizenLeft":["Model.Nation.Citizen"]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Model.Error.Msg":{"args":[],"tags":{"Add":["String.String"],"Timed":["Model.Error.Error"],"Delete":["Model.Error.Error"]}},"Time.Posix":{"args":[],"tags":{"Posix":["Basics.Int"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Dict.NColor":{"args":[],"tags":{"Red":[],"Black":[]}}}}})}});}(this));