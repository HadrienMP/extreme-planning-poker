...
var $author$project$Error$Clean = function (a) {
	return {$: 'Clean', a: a};
};
...
var $author$project$Error$Add = function (a) {
	return {$: 'Add', a: a};
};
	...
	return A3(
		...
		function (error) {
			return $author$project$Messages$ErrorMsg(
				$author$project$Error$Add(error));
		},
	...
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				function (now) {
					return $author$project$Messages$ErrorMsg(
						$author$project$Error$Clean(now));
				})
			]));
};
...
var $author$project$Error$Timed = function (a) {
	return {$: 'Timed', a: a};
};
var $author$project$Error$addError = function (error) {
	return A2(
		$elm$core$Task$perform,
		$author$project$Error$Timed,
		A2(
			$elm$core$Task$map,
			$author$project$Error$Error(error),
			$elm$time$Time$now));
};
...
var $author$project$Error$isVisible = F2(
	function (now, error) {
...
var $author$project$Error$update = F2(
	function (msg, errors) {
		switch (msg.$) {
			case 'Add':
				var content = msg.a;
				return _Utils_Tuple2(
					errors,
					$author$project$Error$addError(content));
			case 'Timed':
				var error = msg.a;
				return _Utils_Tuple2(
					_Utils_ap(
			...
			default:
				...
				return _Utils_Tuple2(
					A2(
						$elm$core$List$filter,
						$author$project$Error$isVisible(now),
						errors),
					$elm$core$Platform$Cmd$none);
		}
	});
							...
							if (e.$ === 'BadStatus') {
								return _Utils_Tuple2(
									...
									A2(
										...
										$author$project$Error$addError('You were kicked out by the server (probably a restart)')));
							} else {
								return _Utils_Tuple2(
									model,
									A2(
						...
						if (response.a.$ === 'BadStatus') {
							return _Utils_Tuple2(
								...
								A2(
									$elm$core$Platform$Cmd$map,
									$author$project$Messages$ErrorMsg,
									$author$project$Error$addError('This name is taken, please try another')));
						} else {
	...
	function (msg, model) {
		if (msg.$ === 'ErrorMsg') {
			...
			return A3(
				...
				A2($author$project$Error$update, errorMsg, model.errors));
		} else {
...
var $author$project$Error$Delete = function (a) {
	return {$: 'Delete', a: a};
};
...
var $author$project$Error$html = function (error) {
	return A2(
		$elm$html$Html$li,
		_List_fromArray(
			[
				$elm$html$Html$Events$onClick(
				$author$project$Error$Delete(error))
			]),
		_List_fromArray(
			[
				A2(
...
var $author$project$Error$view = function (errors) {
	return A2(
		$elm$html$Html$ul,
		_List_fromArray(
			[
		...
		A2($elm$core$List$map, $author$project$Error$html, errors));
};
		...
		_Utils_ap(
			_List_fromArray(
				[
					...
					$elm$html$Html$map,
					$author$project$Messages$ErrorMsg,
					$author$project$Error$view(model.errors))
				]),
			function () {
				var _v0 = model.workflow;
				switch (_v0.$) {
